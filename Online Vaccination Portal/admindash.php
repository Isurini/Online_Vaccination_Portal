...
if (isset($_GET['delete_id'])) {
    ...
    $delete_sql = "DELETE FROM vaccinations WHERE id = '$delete_id'";
...
<body>
    <div class="container">
        <div class="navbar">
            ...
            <ul>
                <li><a href="Display.php" class="active">Manage Users</a></li> 
                <li><a href="babydisplay.php">Manage Baby account</a></li> 
                <li><a href="vaccine.php">Manage Vaccine</a></li>
                <li><a href="baby-record-book.php">Vaccine record</a></li>
                <li><a href="CreateQuestion.php">Ask From Doctor</a></li>
                <li><a href="home.php">Logout</a></li> 
            </ul>
        </div>
        <div class="content">
            <h1>Manage Baby Users</h1>
